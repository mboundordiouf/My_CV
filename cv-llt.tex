...
\leftheader{%
  {\small\bfseries\sffamily DIOUF Mboundor, Ph.D. candidate in Economics}\par
  \makefield{\faEnvelope[regular]}{\tiny\href{mailto:mboundor.diouf@minesparis.psl.eu}{\texttt{mboundor.diouf@minesparis.psl.eu}}}
  \makefield{\faEnvelope[regular]}{\tiny\href{mailto: mboundor.diouf@univ-poitiers.fr}{\texttt{mboundor.diouf@univ-poitiers.fr}}}\par %\makefield{\faEnvelope[regular]}{\tiny\href{mailto: mboundor.diouf@um6p.ma}{\texttt{mboundor.diouf@um6p.ma}}}\par
    \makefield{\faTwitter}{\tiny\href{https://twitter.com/MboundorDiouf}{\texttt{@MboundorDiouf}}}
  \makefield{\faLinkedin}{\tiny\href{https://www.linkedin.com/in/mboundor-diouf-246990163/}{\texttt{Mboundor Diouf}}}
}
